...
function VoucherEdit({ voucherEdit, setVoucherEdit, setVouchers, setMode }) {
    console.group('Editing...', voucherEdit);
    ...
    const handleEdit = async (data) => {
        ...
        try {
            const result = await api.putById(backEndApi.voucher, voucherEdit._id, flatObject(data));
            ...
            setVouchers((prev) =>
                prev.map((voucher) => (voucher._id === result.data._id ? result.data : voucher)),
            );
