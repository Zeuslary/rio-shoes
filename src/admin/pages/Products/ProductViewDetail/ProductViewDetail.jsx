...
function ProductViewDetail({ productViewDetail }) {
            ...
            <CartBox>
                <div className={styles['body']}>
                    ...
                    <p className="cell-item">
                        ...
                        <span>{productViewDetail?.brandName}</span>
                    </p>
                    <p className="cell-item">
                        <span className="cell-title">Category:</span>
                        <span>{productViewDetail?.category}</span>
                    </p>
                    <p className="cell-item">
                        <span className="cell-title">Type:</span>
                        <span>{productViewDetail?.type}</span>
                    </p>
                    <p className="cell-item">
                        <span className="cell-title">Style:</span>
                        <span>{productViewDetail?.style}</span>
                    </p>
                    <p className="cell-item">
                    ...
                    <p className="cell-item">
                        ...
                        <span>{productViewDetail?.design}</span>
                    </p>
                    <p className="cell-item">
                    ...
                    <p className="cell-item">
                        ...
                        <span>{productViewDetail?.tag}</span>
                    </p>
                    <p className="cell-item">
                    ...
                    <p className="cell-item">
                        ...
                        <span>{productViewDetail?.feature?.join(' - ')}</span>
                    </p>
                    <p className="cell-item">
