...
import { API_BASE_URL, keyAdminToken, keyUserToken } from '~/constants';
import storage from './storage.js';

// Create a instance of axios
const createAxiosInstance = (tokenKey, timeout = 10000) => {
...
const instanceAdminAxios = createAxiosInstance(keyAdminToken);
const instanceUserAxios = createAxiosInstance(keyUserToken);
...
const userApi = api(instanceUserAxios);
const adminApi = api(instanceAdminAxios);
